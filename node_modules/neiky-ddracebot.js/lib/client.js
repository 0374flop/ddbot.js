...
var Client = /** @class */ (function (_super) {
    ...
    Client.prototype.botUsername = function() {
        return this.name;
    }
    ...
    Client.prototype.avoirUsernameBot = function () {
        return this.name;
    };
    Client.prototype.joinDDRaceServer = function () {
        var _this = this;
        var _a;
                    ...
                    if (chunk.sys) {
                        ...
                        if (chunk.msgid >= NETMSG_Sys.NETMSG_SNAP && chunk.msgid <= NETMSG_Sys.NETMSG_SNAPSINGLE) {
                            ...
                            if (_this.receivedSnaps == 2) {
                                if (_this.State != States.STATE_ONLINE)
                                    _this.emit('connection_au_serveur_ddrace');
                        ...
                        if (chunk.msgid == NETMSG_Game.SV_EMOTICON) {
                            ...
                            if (unpacked_1.client_id != -1) {
                                unpacked_1.utilisateur = {
                                    InformationDuBot: _this.SnapshotUnpacker.getObjClientInfo(unpacked_1.client_id),
                                    InformationUtilisateur: _this.SnapshotUnpacker.getObjPlayerInfo(unpacked_1.client_id)
                                };
                            }
                        ...
                        if (chunk.msgid == NETMSG_Game.SV_CHAT) {
                            ...
                            if (unpacked_2.client_id != -1) {
                                unpacked_2.utilisateur = {
                                    InformationDuBot: _this.SnapshotUnpacker.getObjClientInfo(unpacked_2.client_id),
                                    InformationUtilisateur: _this.SnapshotUnpacker.getObjPlayerInfo(unpacked_2.client_id)
                                };
                            }
                            _this.emit("message_au_serveur", unpacked_2);
                        }
                            ...
                            if (unpacked_3.victim_id != -1 && unpacked_3.victim_id < 64) {
                                unpacked_3.victim = { InformationDuBot: _this.SnapshotUnpacker.getObjClientInfo(unpacked_3.victim_id), InformationUtilisateur: _this.SnapshotUnpacker.getObjPlayerInfo(unpacked_3.victim_id) };
                            }
                            if (unpacked_3.killer_id != -1 && unpacked_3.killer_id < 64)
                                unpacked_3.killer = { InformationDuBot: _this.SnapshotUnpacker.getObjClientInfo(unpacked_3.killer_id), InformationUtilisateur: _this.SnapshotUnpacker.getObjPlayerInfo(unpacked_3.killer_id) };
